...
insert into KeyResults(id, objective_id, state, name, description, s, m, a, r, t, date_created, date_reviewed) values
  ...
  (23, 21, 'completed', 'Drink a glass of water after waking', 'Start hydration before coffee or breakfast.', 'true', 'Complete this on five weekdays each week', 'Keep a glass beside the bed', 'true', '2026-08-15', '2026-07-20', '2026-07-20'),
  (24, 21, 'failed', 'Keep a water bottle at the desk', 'Make water immediately available during focused work.', 'true', 'Bottle is filled and present on every workday', 'Choose a one-litre bottle', 'true', '2026-08-15', '2026-07-20', '2026-07-20'),
  (25, 21, 'completed', 'Finish two litres of water daily', 'Use the bottle as a simple visual measure.', 'true', 'Reach two litres on five days per week', 'Track refills instead of every sip', 'true', '2026-08-31', '2026-07-20', '2026-07-20'),
  (26, 21, 'failed', 'Drink water before each meal', 'Use meals as natural hydration reminders.', 'true', 'Complete before breakfast, lunch, and dinner', 'Keep water on the table', 'true', '2026-08-15', '2026-07-20', '2026-07-20'),
