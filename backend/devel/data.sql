...
insert into PValues(id, name, description) values
  ...
  (7, 'Home', 'A comfortable, organized, and well-maintained place to live.'),
  (8, 'Community', 'Meaningful participation in the neighbourhood and wider community.'),
  (9, 'Creativity', 'Making space for writing, music, design, and other creative work.');
...
insert into KeyResults(id, objective_id, state, name, description, s, m, a, r, t, date_created, date_reviewed) values
  ...
  (23, 21, 'completed', 'Drink a glass of water after waking', 'Start hydration before coffee or breakfast.', 'true', 'Complete this on five weekdays each week', 'Keep a glass beside the bed', 'true', '2026-06-24', '2026-06-03', '2026-06-24'),
  (24, 21, 'failed', 'Keep a water bottle at the desk', 'Make water immediately available during focused work.', 'true', 'Bottle is filled and present on every workday', 'Choose a one-litre bottle', 'true', '2026-07-01', '2026-06-06', '2026-07-02'),
  (25, 21, 'completed', 'Finish two litres of water daily', 'Use the bottle as a simple visual measure.', 'true', 'Reach two litres on five days per week', 'Track refills instead of every sip', 'true', '2026-07-08', '2026-06-10', '2026-07-08'),
  (26, 21, 'failed', 'Drink water before each meal', 'Use meals as natural hydration reminders.', 'true', 'Complete before breakfast, lunch, and dinner', 'Keep water on the table', 'true', '2026-07-12', '2026-06-14', '2026-07-12'),
  (27, 21, 'active', 'Replace one sweet drink each day', 'Choose water or unsweetened tea instead.', 'true', 'Replace at least five sweet drinks each week', 'Prepare cold tea in advance', 'true', '2026-08-31', '2026-06-18', '2026-07-20'),
  (28, 21, 'active', 'Have water ready before exercise', 'Prepare a bottle as part of changing for activity.', 'true', 'Bring water to every planned session', 'Leave a spare bottle in the gym bag', 'true', '2026-08-15', '2026-06-21', '2026-07-19'),
  (29, 21, 'active', 'Refill the bottle after lunch', 'Avoid relying on thirst during the afternoon.', 'true', 'Refill before returning to afternoon work', 'Set a lunch-end reminder', 'true', '2026-07-26', '2026-06-25', '2026-07-20'),
  (30, 21, 'active', 'Track hydration for two weeks', 'Learn which parts of the day need a better cue.', 'true', 'Log intake for fourteen consecutive days', 'Use a short phone note', 'true', '2026-08-03', '2026-06-29', '2026-07-18'),
  (31, 21, 'active', 'Add electrolytes after long workouts', 'Use them only after longer or hotter sessions.', 'true', 'Use an electrolyte drink after every 90-minute session', 'Keep packets with workout supplies', 'true', '', '2026-07-01', '2026-07-16'),
  (32, 21, 'active', 'Notice afternoon energy levels', 'Relate hydration habits to the usual afternoon slump.', 'true', 'Record a brief 15:00 energy rating on ten workdays', 'Use a one-to-five scale', 'true', '2026-08-07', '2026-07-03', '2026-07-20'),
  (33, 21, 'active', 'Choose water when eating out', 'Keep the habit practical in social settings.', 'true', 'Order water first at four meals out', 'Ask for a carafe at the table', 'true', '2026-08-31', '2026-07-05', '2026-07-17'),
  (34, 21, 'active', 'Prepare a reusable travel bottle', 'Avoid losing the routine on days away from home.', 'true', 'Carry water on every commute for two weeks', 'Keep the bottle beside keys', 'true', '2026-08-10', '2026-07-08', '2026-07-21'),
  (35, 21, 'active', 'Avoid caffeine after midday', 'Reduce the chance of using coffee instead of rest and water.', 'true', 'No caffeinated drinks after 12:00 on five weekdays', 'Switch to herbal tea', 'true', '2026-08-31', '2026-07-11', '2026-07-15'),
  (36, 21, 'active', 'Review hydration weekly', 'Adjust cues based on what was missed that week.', 'true', 'Complete a five-minute review every Sunday', 'Use the hydration notes', 'true', 'text', '2026-07-13', '2026-07-20'),
  (37, 21, 'active', 'Keep water by the bed overnight', 'Make it easy to drink if waking thirsty.', 'true', 'Water is prepared beside the bed each evening', 'Use a covered glass', 'true', '2026-08-15', '2026-07-16', '2026-07-21');
...
insert into Tasks(id, kr_id, state, value) values
  ...
  (22, 27, 'finished', 'Replace the afternoon soda with sparkling water'),
  (23, 27, 'active', 'Prepare unsweetened iced tea in the morning'),
  (24, 27, 'failed', 'Avoid the vending machine after lunch'),
  (25, 28, 'finished', 'Fill the gym bottle before leaving home'),
  (26, 28, 'active', 'Put a spare bottle in the training bag'),
  (27, 29, 'active', 'Set a reminder for the end of lunch'),
  (28, 29, 'failed', 'Refill immediately after every lunch this week'),
  (29, 30, 'finished', 'Create a two-week hydration note template'),
  (30, 30, 'active', 'Record today’s water intake'),
  (31, 31, 'failed', 'Choose an electrolyte product without checking dosage'),
  (32, 32, 'active', 'Record the 15:00 energy score'),
  (33, 33, 'finished', 'Order water first at the last restaurant visit'),
  (34, 34, 'active', 'Wash and pack the travel bottle'),
  (35, 35, 'failed', 'Replace every afternoon coffee immediately'),
  (36, 36, 'finished', 'Write the first weekly hydration review'),
  (37, 37, 'active', 'Place a covered glass beside the bed');
